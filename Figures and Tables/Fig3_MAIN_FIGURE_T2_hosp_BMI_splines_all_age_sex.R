...
##Set reference to 30 (around median)
dd <- datadist(cohort %>% select(!cysticfibrosis_diag_date))
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model <- cph(Surv(survival_time,outcome) ~ rcs(bmi_value,5) + gender + age_cat + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model <- cph(Surv(survival_time,outcome) ~ rcs(bmi_value,3) + gender + age_cat + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
               preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
               recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
               preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
               ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model_0 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(bmi_value,5) + gender + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model_1 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(bmi_value,5) + gender + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
predict_1 <- Predict(model_1, bmi_value = seq(18,50, by =1), subgroup=1, ref.zero=TRUE, fun = exp)
...
plot<- ggplot(data=subgroup_df,aes(x=bmi_value, y=yhat, group = subgroup)) +
  ...
  scale_x_continuous(breaks = seq(20,50,10), limits = c(18,50)) +
  scale_y_continuous(breaks = seq(0.5,3,0.5), limits = c(0.5,3)) +
  labs(x = "BMI (kg/m2)", y = "Hazard ratio", title = "Age", subtitle = paste0(infection.name)) +
  theme(axis.line = element_line(colour =  "grey50" ),
        plot.title = element_text(size=10, face = "bold"), plot.subtitle = element_text(size=10), plot.margin = margin(1,1,0,1,"cm"),
        axis.text = element_text(size = 10), axis.title = element_text(size = 10),
        panel.grid.major = element_blank(),
...
#Density line
density <- ggplot(cohort, aes(x = bmi_value, colour = subgroup)) +geom_density(position = "identity", size = 0.75) +
  scale_x_continuous(breaks = seq(20,50,10), limits = c(18,50)) +
  theme(legend.title = element_blank(), panel.background = element_blank(), legend.position = "none") +
  theme(axis.ticks.y = element_blank(),
        axis.text.x = element_text(size = 10),
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model_0 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(bmi_value,3) + gender + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model_1 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(bmi_value,3) + gender + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model_0 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(bmi_value,5) + age_cat + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model_1 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(bmi_value,5) + age_cat + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
plot<- ggplot(data=subgroup_df,aes(x=bmi_value, y=yhat, group = subgroup)) +
  ...
  scale_x_continuous(breaks = seq(20,50,10), limits = c(18,50)) +
  scale_y_continuous(breaks = seq(0.5,3,0.5), limits = c(0.5,3)) +
  labs(x = "BMI (kg/m2)", y = "Hazard ratio", title = "Sex", subtitle = paste0(infection.name)) +
  theme(axis.line = element_line(colour =  "grey50" ),
        plot.title = element_text(size=10, face = "bold"), plot.subtitle = element_text(size=10), plot.margin = margin(1,1,0,1,"cm"),
        axis.text = element_text(size = 10), axis.title = element_text(size = 10),
        panel.grid.major = element_blank(),
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model_0 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(bmi_value,3) + age_cat + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","bmi_value"] <- 30
model_1 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(bmi_value,3) + age_cat + eth5 + imd_quintile + region + duration_cat + hba1c_cat + number_complications + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
pdf("Fig3_MAIN_FIGURE_T2_hosp_BMI_splines_all_age_sex.pdf",width=16,height=16)
combined_plot
dev.off()
