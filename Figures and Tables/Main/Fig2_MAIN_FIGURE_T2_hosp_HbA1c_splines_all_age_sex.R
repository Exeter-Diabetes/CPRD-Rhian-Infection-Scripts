...
#Plot of the association of continuous HbA1c with hospitalisation for Covid-19, influenza, and pneumonia in type 2 diabetes
...
##Set reference to 53 and run model for all
dd <- datadist(cohort %>% select(!cysticfibrosis_diag_date))
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model <- cph(Surv(survival_time,outcome) ~ rcs(hba1c_value,5) + gender + age_cat + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
...
#Save table of HR/ 95%CI values
output_table <- predict_df %>% select(hba1c_value, yhat, lower, upper)
write_csv(output_table, paste0("hba1c_overall_spline_values_", infection, ".csv"))
...
#Plot
plot<- ggplot(data=predict_df,aes(x=hba1c_value, y=yhat)) +
  geom_line(data=predict_df,aes(x=hba1c_value, y=yhat), size=0.75) +
  geom_ribbon(data=predict_df,aes(x=hba1c_value,ymin=lower,ymax=upper),alpha=0.2) + 
  geom_hline(yintercept =1, linetype = "dashed") +
  scale_x_continuous(breaks = seq(30,120,10), limits = c(30,120)) +
  scale_y_continuous(breaks = seq(0.5,3,0.5), limits = c(0.5,3)) +
  labs(x = "HbA1c (mmol/mol)", y = "Hazard ratio", title = "All", subtitle = paste0(infection.name)) +
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model <- cph(Surv(survival_time,outcome) ~ rcs(hba1c_value,3) + gender + age_cat + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
               preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
               recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
               preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
               ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
#Code subgroup as binary variables
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model_0 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(hba1c_value,5) + gender + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
predict_0 <- Predict(model_0, hba1c_value = seq(30,120, by =1), subgroup =0, ref.zero=TRUE, fun = exp)
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model_1 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(hba1c_value,5) + gender + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
predict_1 <- Predict(model_1, hba1c_value = seq(30,120, by =1), subgroup=1, ref.zero=TRUE, fun = exp)
...
plot<- ggplot(data=subgroup_df,aes(x=hba1c_value, y=yhat, group = subgroup)) +
  ...
  scale_x_continuous(breaks = seq(30,120,10), limits = c(30,120)) +
  scale_y_continuous(breaks = seq(0.5,3,0.5), limits = c(0.5,3)) +
  labs(x = "HbA1c (mmol/mol)", y = "Hazard ratio", title = "Age", subtitle = paste0(infection.name)) +
  theme(axis.line = element_line(colour =  "grey50" ),
        plot.title = element_text(size=10, face = "bold"), plot.subtitle = element_text(size=10), plot.margin = margin(1,1,0,1,"cm"),
        axis.text = element_text(size = 10), axis.title = element_text(size = 10),
        panel.grid.major = element_blank(),
...
#Density line
density <- ggplot(cohort, aes(x = hba1c_value, colour = subgroup)) +geom_density(position = "identity", size = 0.75) +
  scale_x_continuous(breaks = seq(30,120,10), limits = c(30,120)) +
  theme(legend.title = element_blank(), panel.background = element_blank(), legend.position = "none") +
  theme(axis.ticks.y = element_blank(),
        axis.text.x = element_text(size = 10),
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model_0 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(hba1c_value,3) + gender + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model_1 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(hba1c_value,3) + gender + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model_0 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(hba1c_value,5) + age_cat + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model_1 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(hba1c_value,5) + age_cat + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
plot<- ggplot(data=subgroup_df,aes(x=hba1c_value, y=yhat, group = subgroup)) +
  ...
  scale_x_continuous(breaks = seq(30,120,10), limits = c(30,120)) +
  scale_y_continuous(breaks = seq(0.5,3,0.5), limits = c(0.5,3)) +
  labs(x = "HbA1c (mmol/mol)", y = "Hazard ratio", title = "Sex", subtitle = paste0(infection.name)) +
  theme(axis.line = element_line(colour =  "grey50" ),
        plot.title = element_text(size=10, face = "bold"), plot.subtitle = element_text(size=10), plot.margin = margin(1,1,0,1,"cm"),
        axis.text = element_text(size = 10), axis.title = element_text(size = 10),
        panel.grid.major = element_blank(),
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model_0 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(hba1c_value,3) + age_cat + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
options(datadist="dd")
dd$limits["Adjust to","hba1c_value"] <- 53
model_1 <- cph(Surv(survival_time,outcome) ~ subgroup * rcs(hba1c_value,3) + age_cat + eth5 + imd_quintile + region + duration_cat + number_complications + bmi_cat + smoking_status +
                 preindex_hypertension + preindex_af + preindex_angina + preindex_myocardialinfarction + preindex_revasc + preindex_ihd + preindex_heartfailure + preindex_pad +
                 recent_hosp_resp_infect + recent_hosp_anything + preindex_asthma + preindex_copd + preindex_bronchiectasis + preindex_pulmonaryfibrosis + preindex_pulmonaryhypertension + 
                 preindex_tia + preindex_stroke + preindex_dementia + preindex_otherneuroconditions + preindex_haem_cancer + preindex_solid_cancer + preindex_solidorgantransplant + preindex_cld +
                 ckd_stage + acr_cat + treatment_6m + oralsteroids_6m + immunosuppressants_6m + labas_6m + ltras_6m, data = cohort, x= T, y=T)
...
pdf("Fig2_MAIN_FIGURE_T2_hosp_HbA1c_splines_all_age_sex.pdf",width=16,height=16)
combined_plot
dev.off()
