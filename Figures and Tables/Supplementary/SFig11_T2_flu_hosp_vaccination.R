################################################################################
#Script to produce Supplementary Figure 11
#Sensitivity analysis in people with influenza vaccination in the 2 years prior to the index date and those without
#Forest plot of all risk factor associations for influenza hospitalisation in vaccinated vs unvaccinated people with type 2 diabetes
