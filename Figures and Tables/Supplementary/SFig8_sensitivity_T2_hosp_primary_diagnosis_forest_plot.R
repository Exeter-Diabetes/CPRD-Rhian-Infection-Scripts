################################################################################
#Script to produce Supplementary Figure 8
#Sensitivity analysis restricting outcome to infection as a primary diagnoses of hospitalisation
#Forest plot of all risk factor associations for Covid-19, influenza, and pneumonia hospitalisation (primary diagnosis) in type 2 diabetes
...
pdf("SFig8_sensitivity_T2_hosp_primary_diagnosis_forest_plot.pdf",width=10,height=14)
fp
dev.off()
