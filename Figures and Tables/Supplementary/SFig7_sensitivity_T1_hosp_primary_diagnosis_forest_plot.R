################################################################################
#Script to produce Supplementary Figure 7
#Sensitivity analysis restricting outcome to infection as a primary diagnoses of hospitalisation
#Forest plot of clinical and sociodemographic risk factor associations for Covid-19, influenza, and pneumonia hospitalisation (primary diagnosis) in type 1 diabetes
