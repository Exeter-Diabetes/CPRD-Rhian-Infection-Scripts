################################################################################
#Script to produce Supplementary Figure 6b
#Plot of the association of continuous BMI with hospitalisation for Covid-19, influenza, and pneumonia in type 1 diabetes
