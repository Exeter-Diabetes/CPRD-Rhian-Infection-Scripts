...
#Forest plot of all risk factor associations for Covid-19 and pneumonia mortality in type 2 diabetes
...
pdf("SFig4_T2_mortality_forest_plot.pdf",width=10,height=14)
fp
dev.off()
